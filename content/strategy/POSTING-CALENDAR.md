...
- **Bio (suggested):** `Websites for schools & clinics in Cameroon.` / `Bilingual EN/FR. Easy WhatsApp contact.` / `Get your free 24h homepage preview below.` — display name: `AMK | Web Design Cameroon`.
- **Link field:** `https://amk-cm.vercel.app/?utm_source=<platform>&utm_medium=organic_social&utm_campaign=profile` (UTM attributes only if analytics collect it).
