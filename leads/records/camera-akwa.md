...
| Relances envoyées | 0 |
| Source | directory |
| Détail source | 252 clics WhatsApp mesurés (DoualaTour) — le plus fort du lot |

## Notes

Envoi 18/09 ~18:30 SANS maquette (vitesse). Maquette disponible : clients/douala-cliniques/01-camera.jpg. · ⚰️ MORT le 22/09 (lot du 18/09) — jamais ouvert, jamais répondu ; décision de King : on ne réécrit plus, on va vers des prospects frais. Aucune relance programmée.
