...
| Champ | Valeur |
|---|---|
| Slug | comobil-college-moderne-bilingue-les-laureats |
| Type | school |
...
- **Retenu :** parked — une kill list doit se DÉDUIRE de l'état réel (score 18 ET non parké ET non disqualifié).
- **Écarté :** la liste figée du playbook, qui met sur une liste « TODAY » un lead parké depuis cinq jours.
