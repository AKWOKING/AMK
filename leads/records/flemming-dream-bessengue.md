...
| Relances envoyées | 0 |
| Source | directory |
| Détail source | pagespratiquescm (liste papier — absent des annuaires en ligne) |

## Notes

Envoyé le 19/09 à 19:30 — lu (2 coches). · ⚰️ MORT le 22/09 (lot du 19/09) — jamais ouvert, jamais répondu ; décision de King : on ne réécrit plus, on va vers des prospects frais. Aucune relance programmée.
