...
| Relances envoyées | 0 |
| Source | directory |
| Détail source | profil WhatsApp Business vérifié (capture King) |

## Notes

Envoyé 18/09 13:42. Maquette : clients/douala-cliniques/06-malia-labo.jpg · ⚰️ MORT le 22/09 (lot du 19/09) — jamais ouvert, jamais répondu ; décision de King : on ne réécrit plus, on va vers des prospects frais. Aucune relance programmée.
...
`L27` · | **ven 18/09 13:42** | **Malia Labo** (694 56 22 44) | msg 1 + maquette | **Envoyé — 2 coches (distribué)** | **Non** |
