...
| Champ | Valeur |
|---|---|
| Slug | cidm-saint-joseph |
| Type | lab |
| Ville | Douala |
| Langue de contact | FR |
| Étape | parked |
| WhatsApp | 674 30 07 98 |
| Numéro vérifié | unknown |
| Canal | WhatsApp |
| Contacté | Yes |
| Relances envoyées | 0 |
| Source | directory |
| Détail source | goafricaonline |

## Notes

Envoyé le 19/09 à 19:29 — lu (2 coches). · ⚰️ MORT le 22/09 (lot du 19/09) — jamais ouvert, jamais répondu ; décision de King : on ne réécrit plus, on va vers des prospects frais. Aucune relance programmée.
