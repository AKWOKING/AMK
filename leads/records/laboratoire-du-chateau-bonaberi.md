...
| Champ | Valeur |
|---|---|
| Slug | laboratoire-du-chateau-bonaberi |
| Type | lab |
...
`L31` · | **ven 18/09 ~18:30** | **Laboratoire du Château** (Bonabéri, 676 94 69 93) | msg 1 — **sans maquette** | Envoyé | **Non** |
