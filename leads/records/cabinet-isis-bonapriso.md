...
| Champ | Valeur |
|---|---|
| Slug | cabinet-isis-bonapriso |
| Type | clinic |
| Ville | Douala (Bonapriso) |
| Langue de contact | FR |
| Étape | qualifying |
| WhatsApp | 699 34 93 89 |
| Numéro vérifié | yes |
| Canal | WhatsApp |
| Contacté | Yes |
| Réponse | No |
...
`L35` · | **ven 18/09 ~19:00** | **Cabinet Médical ISIS** (Bonapriso, 699 34 93 89) | msg 1 — sans maquette | Envoyé | **Non** |
