...
| Champ | Valeur |
|---|---|
| Slug | cabinet-idoc-bonapriso |
| Type | clinic |
| Ville | Douala (Bonapriso) |
| Langue de contact | FR |
| Étape | parked |
| WhatsApp | 699 68 05 88 |
| Numéro vérifié | yes |
| Canal | WhatsApp |
| Contacté | Yes |
| Réponse | No |
...
`L37` · | **ven 18/09 ~19:00** | **Cabinet Médical i'DoC** (Bonapriso, 699 68 05 88) | msg 1 — sans maquette | Envoyé | **Non** |
