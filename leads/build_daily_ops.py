...
r("", "", "", "", "")
r("TUE 15 SEP — DIGITAL-FIRST, CLINICS FIRST (King: clinics have more potential than schools). Plan = sales/Invitation-First-Replan-2026-09-15.md + sales/Clinic-Batch-2026-09-15.md. STANDING (King): every msg 1 goes WITH its mockup image (demos/shots/*-wa.jpg). DEPLOY NON-URGENT (King 15:58): /clinic-bonaberi.html LIVE as a partial rename — LEAVE IT, 'just a demo concept'; canonical fully-renamed zip ships on the next natural deploy; /mitoc.html 404 here is fine (named link = separate mitoc-concept.vercel.app).", "", "", "", "")
r("", "", "", "", "")
...
r("⭐ Solidarity Clinic & Laboratory (Solidarity Health Foundation, Malingo/Molyko) — CLINIC #1",
  ...
  "NOT MESSAGED TUE (King confirmed 15:58: no direct WhatsApp line): front number voice-only; 691 63 29 41 Dr Njang personal forever HOLD; admin 677 61 12 07 = optional 60-SECOND PROFILE-ONLY check tonight (do not send on a guess) else FIRST TOUCH = WED sealed envelope to 'current medical director or clinic manager'. If the profile answers as the clinic, Wednesday morning msg 1 (mockup-clinic image + text) is a go.", "☐", "Wed")
...
r("St. Theresa STIBCCOL Molyko — REPLIED TWICE; FU PERMISSION GRANTED 22:51",
  ...
  "20:44 soft objection (site in the making, October, 'already late') → King soft-ack 22:25 → 22:51 they replied 'Ok thanks you can get back to me for a follow up' = EXPLICIT INVITATION (logged verbatim, timer now 90 days). King sends 3-line close confirming October + contact save. NO link/mockup pushed; TikTok fallback CANCELLED. FU Wed 14 Oct arrives as an invited check-in (is it live? free review) → FU2 Wed 4 Nov if silent → stop.", "☑", "Tue")
...
r("· Schools status evening 15 Sep: St Theresa 679 15 10 75 REPLIED 20:44 — site in the making for October ('already late'); soft-ack sent, free-review bridge, FU 14 Oct, no pitch. Baird 677 87 53 95 SENT 14:41 (img+text, awaiting) — link pack ready; personal line, never name proprietress/photo; pre-tap site check. Baptist 679 65 07 07 SENT, inbound only (BOARD). PCSS 652 075 229 PARKED (BOARD; Kinang cancelled). RULE: missionary/confessional secondaries = BOARD-BUYER like government; principals can't sign; no counted slots, no chases.", "", "", "", "")
r("· DEPLOY = OPTIONAL NOW (King 15:58: clinic demo stays as-is). When a natural deploy happens: amk-site.zip (13 files, smoke-tested) -> EXISTING amk-cm project; it completes the Bonabéri rename (Buea eyebrow leftover), cleans the stale homepage external card, and adds /mitoc.html. Steps in site/DEPLOY.md.", "", "", "", "")
...
r("· Any 'yes send it' → sample link immediately (schools /sample-secondary.html LIVE; clinics /clinic-bonaberi.html LIVE demo (placeholder caption; partial rename accepted by King 15:58), mockup-clinic-wa.jpg attached first); MITOC yes → mitoc-concept.vercel.app. Named concept request → AMK builds within 24h; move to kill list + book time.", "", "", "", "")
