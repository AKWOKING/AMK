...
| Contactés | **54** | 36.2 % de la base |
| Réponses humaines | **4** | 7.4 % des contactés |
...
1. **Le volume contacté est le premier goulot** : 95 lead(s) sur 149 n'ont jamais reçu un message (64 % de la base). Aucune amélioration de texte ne compense un lead jamais contacté.
2. **Le taux de réponse humain** est de 7.4 % des contactés — c'est le chiffre à surveiller d'un envoi à l'autre (il se lit avec `SOURCES.md` : quelle liste répond).
