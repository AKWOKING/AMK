...
| Réponses humaines | **6** | 9.8 % des contactés |
...
2. **Le taux de réponse humain** est de 9.8 % des contactés — c'est le chiffre à surveiller d'un envoi à l'autre (il se lit avec `SOURCES.md` : quelle liste répond).
