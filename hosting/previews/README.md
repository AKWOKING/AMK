...
|---|---|---|---|
| **separate Vercel project** | ⏳ to deploy as **https://theskye-dental.vercel.app/** (`skye` folder ready) | Cabinet Dentaire The Skye, Bonamoussadi Douala | `demos/concept-skye-v1.html` |
