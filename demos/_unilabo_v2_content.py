...
FAMILIES = [
    dict(slug="biochimie",
         alt_fr="Six tubes à bouchon bleu, remplis d'un liquide jaune, dans un portoir violet ; une micropipette est posée à côté.",
         alt_en="Six blue-capped tubes of yellow liquid in a purple rack, with a micropipette lying beside them.", fr="Biochimie", en="Biochemistry",
    ...
    dict(slug="hematologie",
         alt_fr="Un frottis sanguin vu au microscope : des globules rouges roses et plusieurs globules blancs violets.",
         alt_en="A blood smear under the microscope: pink red cells and several purple white cells.", fr="Hématologie", en="Haematology",
    ...
    dict(slug="serologie",
         alt_fr="Une pipette dépose un échantillon dans les puits d'une plaque d'analyse à fond violet.",
         alt_en="A pipette dropping a sample into the wells of a purple-bottomed assay plate.", fr="Sérologie &amp; immunologie", en="Serology &amp; immunology",
    ...
    dict(slug="hormonologie",
         alt_fr="Un automate de laboratoire : un bras mécanique saisit un petit flacon au-dessus d'un carrousel de tubes à bouchons colorés.",
         alt_en="A laboratory analyser: a mechanical arm lifts a small vial above a carousel of colour-capped tubes.", fr="Hormonologie", en="Hormonology",
