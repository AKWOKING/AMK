...
- **Agency site:** `site/index.html` (+ `amk-site.zip`) — links to Vercel deployments `amk-cm.vercel.app` and `demo-cliniques-cm.vercel.app` (source of the clinic demo NOT in repo — blocker).
...
1. ✅ RESOLVED 14 Sep: King self-hosts — bundle `hosting/previews/` (oracare/sasse/comobil/sah, noindex, deploy steps in its README). Repo still needs the `demo-cliniques-cm.vercel.app` source folder.
2. Clinic "three demos" site source missing from repo.
3. MoMo collection name/number for deposits.
4. King phone-checks: sahiscol.org, comobil.com, GBP verification status.
...
6. New-lead batch (8 D/E prospects for Douala/Buea/Limbé, clinics + schools) due Tue 15 in this file + workbook.
