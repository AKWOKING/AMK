# Journal d'activité — vérité des envois et des réponses

**Pourquoi ce fichier existe.** Le 18/09, j'ai écrit dans un résumé que « OraCare et MITOC ont répondu ». **C'est faux.** Oracle a écrit le contraire et j'ai parlé de mémoire au lieu de lire ce fichier. King a corrigé. Cette erreur a coûté du temps et de la confiance : ce journal remplace la mémoire par des faits vérifiables.

**Règle :** une ligne par envoi et par réponse. **« Envoyé » ≠ « lu » ≠ « répondu ».** Un message à une coche grise **n'a pas été lu**, et cela s'écrit tel quel.

---

## 1 · État vrai au vendredi 18 septembre 2026

| Date | Prospect | Message | État réel | Réponse |
|---|---|---|---|---|
| lun 14/09 | **OraCare237** (672 52 66 86) | msg 1 | **Pas lu** | **Non** |
| mar 15/09 | **MITOC** (678 90 89 62) | msg 1 | Envoyé, 2 coches | **Non** |
| mar 15/09 | **Baptist Comprehensive** (679 65 07 07) | msg 1 | Envoyé, 1 coche | **Non** |
| mar 15/09 | **Baird Memorial** (677 87 53 95) | msg 1 + image | Envoyé, 1 coche | **Non** |
| mar 15/09 15:45 | **St. Theresa** (679 15 10 75) | msg 1 | Envoyé | ✅ **OUI — 20:44** |
| mar 15/09 22:25 | St. Theresa | accusé de réception | Envoyé | ✅ **22:51 — permission de revenir en octobre** |
| mer 16/09 | OraCare237 | FU1 (M+2) | Envoyé | **Non** |
| mer 16/09 | Cabinet Dentaire The Skye (677 79 69 99) | msg 1 | Envoyé | **Non** |
| mer 16/09 | Cabinet dentaire YAKS (672 70 20 78) | msg 1 | Envoyé | **Non** |
...
| **ven 18/09 ~18:30** | **Discovery Labs** (Bassong, 694 86 13 61) | msg 1 — **sans maquette** | Envoyé | **Non** |
| **ven 18/09 ~18:30** | **UNI-LABO** (696 13 98 19) | msg 1 — **sans maquette** | Envoyé | **Non** |
| **ven 18/09 ~18:30** | **YONDJA ANALYSE** (696 88 88 23) | msg 1 — **sans maquette** | Envoyé | **Non** |
| **ven 18/09 ~18:30** | **Laboratoire du Château** (Bonabéri, 676 94 69 93) | msg 1 — **sans maquette** | Envoyé | **Non** |
...
| **ven 18/09 20:57** | **UNI-LABO** (696 13 98 19) | *« Bsr »* | Envoyé 18:41 (2 coches) | ✅ **OUI — RÉPONSE HUMAINE, 20:57** |
| **ven 18/09 20:22** | **The Skye** (Bonamoussadi, 677 79 69 99) | **FU1 (M+2)** — texte du pack §A | Envoyé | **Non** |
| **ven 18/09 20:22** | **Cabinet dentaire YAKS** (Logbessou, 672 70 20 78) | **FU1 (M+2)** — texte du pack §B | Envoyé | **Non** |
...
- **Fils ouverts sans réponse au 18/09 :** OraCare · MITOC · Baptist Comprehensive · Baird Memorial · The Skye · YAKS · AFRIQUE LABO · L'Opticien · La Béthanie · JEMPO. **31 fils ouverts · 2 réponses humaines (St. Theresa, UNI-LABO) · PRR = 2/31 = 6,5 %.**
...
1. **Le CRM `leads_50.xlsx` était juste** — sa colonne *Reply* est vide pour MITOC, Baird et Baptist, et porte le verbatim de St. Theresa. **L'erreur venait de moi, pas des données.** J'ai résumé de mémoire au lieu de relire le fichier.
2. **Un « envoyé » ne devient jamais un « répondu » par approximation.** Deux coches = distribué, pas lu. Une coche = parti. Le silence n'est pas un demi-oui.
3. **Avant tout résumé de pipeline, relire ce journal et `leads_50.xlsx`.** Jamais la mémoire de conversation.

## 3 · Règle de tenue à partir d'aujourd'hui

- Après chaque envoi : une ligne, avec l'heure et le nombre de coches.
- Après chaque réponse : **le verbatim**, tel quel, entre guillemets.
- Toute prévision (« il va probablement répondre ») est interdite dans ce fichier : on n'y écrit que ce qui est arrivé.


---

## Clôture — vendredi 18 septembre 2026, 20:22

**Liste confirmée par King. 21 nouveaux messages + 2 relances aujourd'hui.**

| Heure | Destinataires |
|---|---|
| 13:39 · 13:42 | Adonaï · Malia Labo |
| ~18:30 | Discovery Labs · UNI-LABO · YONDJA ANALYSE · Laboratoire du Château · Département Biologique · CAMERA · LE NID |
| ~19:00 | ISIS · La Cerisaie · i'DoC · Capucines · Brulet Epaka · Kouam Samuel · DAS Group |
| 19:42 | Centre Médical de Bonanjo · Kamaïs Optic |
| 20:02 | Cabinet Dentaire Emmanuel · Clinique de L'université · MEDI LABO |
| 20:22 | **Relances M+2** : The Skye · YAKS |
...
2. **La vérification d'identité à l'écran est obligatoire** : elle a évité « Kingdom Family Int'l » (un cabinet de finances) et INSES (une école) — deux messages qui seraient partis à la mauvaise personne.
...
## Lundi 21/09/2026 — 17:30 · les 5 décisions de King exécutées, le lot 1 écrit, et deux trous trouvés en route

**Casquette : Sales Operator + Build Lead.** Rien n'a été envoyé — je ne suis pas le canal. Tout est écrit
pour que King envoie, et chaque envoi s'enregistrera dans la même réponse que l'envoi.

### 1 · Les réponses de King (17:00), telles quelles

| # | Sa décision | Ce que j'ai fait |
|---|---|---|
| ① | **Skye + YAKS : parked.** La FU du 18/09 est bien partie sur les deux fils — ses captures le prouvent (Skye 16/09 16:19 ✓✓ puis 18/09 20:14 ✓✓ **jamais ouverts** ; YAKS 16/09 16:43 ✓✓, maquette **à double flèche de transfert**, texte ✓✓ non lu). | Les deux lignes passent `qualified → parked`, `stage_since=2026-09-21`, `last_send_state=delivered_unread`, `follow_ups_sent` reste **1** (la FU du 20/09 n'est pas partie et ne partira pas). Gâchette de réveil dans `bamfam_next_step`. Et **`Daily-Plan.csv` les affiche maintenant comme `NE PAS RELANCER (parqué)`** — voir §3. |
| ② | **St. Theresa : oui, elle compte dans le PRR.** | Sa `Reply` porte le verbatim, pas un « yes » : la déduction ne la voyait pas. Forcée à la main (`reply_type=human`, verbatim des 15/09 20:44 + 22:51 dans la cellule). Le PRR passe de 4,4 % à **6,7 % (3/45)** — et retombe à **6,5 % (3/46)** quand AFRIQUE LABO entre au tableau (§2). Sa `stage_since` = **21/09**, la date de la décision de parking, pas celle de la réponse. |
| ③ | **org_type : « va ligne par ligne sur les faits écrits dans la ligne. »** | Fait — **mais je n'ai pas trié à la main une par une : j'ai supprimé la cause.** `crm.py` collait `"school"` aux 38 lignes du classeur **sans jamais lire la ligne** ; voilà d'où venaient MITOC « school » et Solidarity « school ». Nouveau `org_type_for()` : l'étiquette n'existe que si un mot **du nom, des Facilities, de l'activité ou des notes** la porte (`lab` → `clinic` → `other` → `school`, dans cet ordre parce qu'« laboratoire d'analyses médicales » n'est pas une clinique). La preuve est écrite dans `Notes` (`org_type=lab prouvé par « laboratoire »`). Les overrides explicites (MITOC, One Stop, JOSS, Kamaïs, Solidarity) gagnent avant. **Résultat : 0 ligne sans étiquette et 0 ligne sans preuve** — contre 145 dont 38 affirmées « school » par défaut. |
| ④ | **Le site `amk-cm.vercel.app` :** contrôle demandé sur les pages concernées. | `audit_html.py` sur les 3 pages récupérées du dépôt = **0 finding**. Les liens de concepts cités dans les textes d'envoi ont été **vérifiés en ligne, un par un** : `bonanjo` · `concept-skye` · `concept-yaks-v1` · `mitoc-concept` · `uni-labo` · `concept-afriquelabo-v1` = vivants ; **`amk-cm.vercel.app/yaks/` renvoie 404** → aucune phrase d'envoi ne doit pointer sur ce chemin (les maquettes nommées ne sont pas listées, règle du 17/09). |
| ⑤ | **Contenu :** la dé-identification de V-05 est pour demain ; la sortie vidéo reste gelée tant que l'outreach n'a rien clos. | Constaté, rien de plus fait ici. `ffmpeg`/`playwright`/`PIL` toujours absents du bac → **aucun rendu possible dans cette session**, ce n'est pas un choix. |

### 2 · AFRIQUE LABO n'était pas dans le CRM — 4 messages, une relance due, aucune ligne

En écrivant le lot, j'ai voulu lire sa ligne : **elle n'existe pas.** Le lead ne vivait que dans
`sales/Outreach-AFRIQUE-LABO-v1.md` et le journal. Conséquence mécanique, pas une opinion : un lead hors
tableau n'a **pas de cadencement calculé, pas de compteur de relances, pas de place au PRR, pas de fiche**
— et sa date due ne vit que dans la tête de qui l'a lue.

Corrections : `afrique-labo-sarl` **ajouté comme 146ᵉ ligne**, uniquement avec des faits déjà écrits dans le
dépôt (msg 1 jeu 17/09 13:24 · FU1 sam 19/09 confirmée par King → `follow_ups_sent=1` · FU2 lun 21 · FU3
jeu 24 · `presented` · `lab` · WhatsApp Business nommé « Afrique labo sarl » vérifié 17/09 · `afriqlabo.com`
**et** `.net` en `NXDOMAIN` au contrôle King du 16/09 ~17:00 · Dr Takala Cathérine · ⛔ 674 46 62 15 ·
secours 699 73 36 25 seulement sur invitation · portail obligatoire 10 s avant chaque envoi).

**Et cette inscription a révélé une de mes erreurs, plus grave qu'un oubli de saisie :** le pack de 16:00
disait « AFRIQUE LABO FU2 = mercredi 23/09 → ne rien envoyer aujourd'hui ». **C'était faux** — ce calcul
sortait de ma note de plan du 19/09, alors que le §4 **corrigé le 18/09 dans son propre dossier** donne
FU2 = **lundi 21**, c'est-à-dire aujourd'hui. Le texte n'est pas envoyé : corrigé avant, dans les deux fichiers.
Leçon écrite ici, pas dans une conversation : **une date de relance qui n'existe que dans une phrase de note
de plan est une date fausse en puissance.** Elle est maintenant dans la colonne `Follow-up date` du CRM
(UNI-LABO 2026-09-25 et Labiomed 2026-09-21 y sont entrées en même temps).

### 3 · Deux trous de vue trouvés en chemin (corrigés dans `views.py`)

1. **Les seules affaires à `closing` disparaissaient de la file du jour.** Labiomed et UNI-LABO —
   **200 000 FCFA chiffrés, les deux seuls « oui » de la campagne** — n'apparaissaient pas dans
   `Daily-Plan.csv` : une date de relance planifiée annule « répondre » **et** « relancer », donc un
   rendez-vous déjà fixé devenait invisible. Ajouté : `CONFIRMER LE RENDEZ-VOUS (J-1)` /
   `RENDEZ-VOUS DU JOUR` / `AFFAIRE À CLOSING — la faire avancer`, avec le prix dans la note.
   **Une file qui omet les deux seules ventes en cours n'est pas une file, c'est une liste de regrets.**
2. **Un lead parqué sortait de la mémoire.** Les 7 parqués n'apparaissaient nulle part le jour où l'on
   décide quoi envoyer. Ajouté : `NE PAS RELANCER (parqué)` en bas de file, avec la date de parking et la
   gâchette de réveil. La file passe de 40 à **49 lignes** et **les priorités sont enfin triées** —
   avant, elle était dans l'ordre du tableau, pas dans l'ordre de la journée.

### 4 · Le lot 1 est écrit, pas envoyé

`sales/Send-Pack-2026-09-21-LOT1.md` (247 lignes) — 10 destinataires dans l'ordre d'envoi : Bonanjo
(l'horaire manquant, pas le prix) · MITOC FU2 · Baird FU2 (le domaine **ne répond toujours pas**,
revérifié aujourd'hui, et la formulation reste « your leads land nowhere », jamais « vous n'avez pas de site ») ·
AFRIQUE LABO FU2 (angle : les résultats) · **OraCare conditionnel** — si la FU2 du 20/09 est partie, on
n'écrit pas aujourd'hui, FU3 demain ; sinon le texte est prêt · les 5 premiers opticiens de la Vague 1,
**chacun ouvert par le fait du titulaire public** (1974 pour Tchaya · Bonamoussadi/ACACIAS pour Bely ·
« Univers Optique » introuvable même en tapant son propre nom).
**Et une porte qui bloque, écrite au lieu d'être contournée : les 10 opticiens sont à 1/3** (C seulement) —
la porte A, ouvrir chaque contact et regarder le profil, te prend ~2 minutes par numéro. Sans elle, un envoi
à un profil muet s'enregistre comme **incident de canal, pas comme relance**.

### 5 · Ce que je te demande maintenant

1. **Les 5 opticiens du lot :** ouvre les 5 numéros, dis-moi « nom vu » ou « profil muet ». Si les 5 passent,
   j'écris les 5 suivants (Optic Laser · Planète · Médina · Fashion · MegaOptic) dans la foulée.
2. **OraCare :** la FU2 de dimanche est-elle partie ? (une ligne — ça décide si on écrit aujourd'hui ou demain.)
3. **Rien n'est envoyé tant que tu n'as pas dit « j'y vais ».** À chaque envoi : heure · coches · réponse
   verbatim · profil vérifié oui/non. J'enregistre dans `crm.py` + ce journal **dans la même réponse**.
4. **Trois questions de l'audit du 18/09 §10 restent sans réponse** : les 12 labos de la réserve ·
   la Page Facebook · le parrainage St. Theresa.


---

## Lundi 21/09/2026 — 18:20 · les écrans de King corrigent trois de mes lectures (et le CRM avec)

**Casquette : Sales Operator.** Envoi : King, sur son téléphone. Moi : enregistrement + corrections.

**Ce que les captures ont dit, et que mes fichiers ignoraient :**
- `AFRIQUE LABO` : FU2 partie **17:39 (éditée, une coche)** · message d'amorce du **14/09 13:04 jamais compté**
  → `follow_ups_sent` 1 → **2**, FU3 mer 23/09 max, palier des 3 messages atteint.
- `OraCare` : message de **clôture parti 17:43** → **`parked` le 21/09**, 3 relances au compteur, plus aucune
  relance, retiré de `RELANCE_A_JOUR`. Le fil : 14/09 13:04 · 16/09 14:32 · 21/09 17:43 — 0 réponse, 0 bleu.
- `Baird` : **FU1 jeu 17/09 13:48 envoyée et jamais enregistrée** (la preuve était écrite dans la cellule
  `Contacted` du classeur : « YES 15 Sep 14:41 WA (mockup image + msg 1; one tick) ») → 2 relances comptées,
  FU3 mer 23/09 = la dernière.
- `Le Cristallin` 17:51 · `Univers Optique` 17:50 · `Disc Optique Médicale` 17:48 · `Tchaya Optique` 17:47 :
  message 1 parti, **une coche** sur les quatre → 4 lignes `prospect → qualified`, `first_touched=21/09`,
  `variante_envoi` A/C gravé, profil WhatsApp **vérifié avant envoi** (porte A passée par les faits).
- `Bely Optique Médicale` : **696 85 52 42 n'est pas sur WhatsApp** → incident de canal, `Contacted=No`,
  `disqualification_reason=Canal injoignable`. Jamais une relance ratée.

**Mes trois erreurs, corrigées dans la donnée (pas dans une conversation) :**
1. **« AFRIQUE LABO n'est pas dans le CRM » — c'était faux.** La ligne existait sous `afrique-labo-douala` ;
   j'avais cherché le *nom* dans `crm.py` au lieu du *numéro* dans le CSV. J'ai donc créé un doublon
   (146 lignes, même docteure deux fois, deux cadencements). Doublon supprimé + **garde-fou permanent :
   deux lignes portant le même numéro = build en échec**.
2. **Un parqué ressortait « à relancer »** : OraCare pointait en « Relance 4/3 » dans la file du jour parce
   que `views.py` consultait sa table de dates AVANT de regarder l'étape. Corrigé : `parked`/`lost` ne sont
   jamais dus.
3. **`Contacted` du classeur n'est pas un booléen partout** : une valeur longue (« YES 15 Sep 14:41 WA… »)
   faisait lire la ligne comme *non contactée* et restait dans une colonne oui/non. Normalisée, **et la preuve
   d'envol descendue dans `Notes`**.

**Trou de MA donnée, trouvé en relisant le CRM contre l'écran :** `price_quoted_fcfa` d'AFRIQUE LABO/
Baird OK, mais **celui de Bonanjo (100 000 FCFA annoncé sam 19/09 13:35) n'avait jamais été enregistré** —
la table le laissait vide, donc le fichier le plus important de l'opération racontait qu'aucun prix avait
été dit. `price_quoted_fcfa=100000` + `proposal_sent=2026-09-19` posés, étape **`presented`** (page + prix
vus, pas `closing` : aucune acceptation).

**La correction de texte que King a demandée :** mon brouillon de 17:00 pour Bonanjo supposait un accord
(« j'attends votre feu vert », « je les écris sur la page »). **Réécrit** en une question d'avis + une porte
de sortie, sans prix rappelé — dans `sales/Enregistrements-2026-09-21-SOIR.md` §①. Règle debout ajoutée au
playbook (A9) : **un report poli n'est pas un consentement.**

**Le garde-fou a mordu tout de suite :** `674 93 66 04` était sur DEUX lignes (CEMECES et INSES) — l'erreur
de ma fiche du 18/09. Correction choisie : **retirer le numéro de la ligne CEMECES** (et non créer une
exception), la clinique restant sans canal vérifié, à reprendre par sa page Facebook.

**Écart noté, pas caché :** quatre nouveaux contacts en 4 minutes (17:47→17:51) contre ~10 min prescrites,
à des confrères du même ordre. Écrit dans `crm.py` au-dessus de la table d'envoi.

**Compteur du soir :** 145 lignes · **49 contactées** · PRR **6,1 %** (3 réponses humaines) ·
...
## Lundi 21/09/2026 — 21:15 → 23:20 · Univers Optique (Bépanda) : « digge deep, tout trouver » → dossier de reprise construit, et DEUX ratages du CRM trouvés en route

**La commande, textuelle :** « *from univers optique, build the modern website following our pipeline, look
for inspiration, read the design and SEO docs then start build — this time make sure you dig deep and find
out everything: all his social and google business reviews everything.* » Le mot « tout » a été pris au
sérieux : **six sources lues, dont deux que deux recherches ne donnent jamais** (le DNS du domaine et les
10 captures Wayback). Le fil, lui, était déjà chaud : 17:50 message 1 · **17:56 il demande le prix** ·
18:08 King chiffre (100 000 FCFA · 50/50 · rien dû avant accord) et promet **« un aperçu gratuit d'ici
demain »** → la promesse a fait de ce build **la tâche de la soirée**, devant toute autre réponse.

### 1 · Ce que la fouille a donné, et ce qu'elle a défait

**Défait, d'abord : mon message de 17:50 était faux.** Il affirmait « absent du web ». Or il a (a) une
**fiche Google notée 3,3/5 avec 6 avis**, catégorie Opticien, horaires lun–ven 8h–18h / sam 8h–13h, plus
code **3P3G+JCG**, « entre pharmacie Sass et Express Union », **champ site VIDÉ, aucun réseau relié**
(miroir `docteur.go.yo.fr/univers-optique/`, relevé du 13/09/2025) ; (b) un **domaine enregistré mais mort**
— `getent hosts` ne résout rien, `curl` = 000, et la dernière copie **vivante** date du 02/11/2023, la
capture du 09/01/2024 étant un **répertoire Apache vide** ; (c) une **fiche annuaire Maligah** à son nom
légal `ETS UNIVERS OPTIQUE`, BP 4680, trois lignes téléphoniques, et trois champs vides (e-mail, langues,
moyens de paiement) ; (d) une **annonce kerawa de 2022** encore indexée qui date le début d'activité au
**01/08/2009** et liste **prothèses oculaires** et **verres de sécurité** (le support lui-même est
devenu une page « domaine à vendre » : on cite l'index, jamais la page).

**Trouvé, ensuite, ce qui ne se cherche pas deux fois :** sur SA dernière page vivante, au paragraphe
« Verres et montures », il est écrit « **Chez Gweleo**, vous pouvez désormais adapter des nouveaux verres… »
— le nom d'une enseigne étrangère, resté collé dans son propre texte ; ses **trois cartes « NOS SERVICES »
pointent toutes vers `/examen-de-vue/`** ; une bannière « **15 % de réduction** » tourne sans offre derrière.
Et en cherchant « Univers Optique avis », le premier résultat détaillé est un **homonyme de Moselle noté
4,9/5 sur 9 avis** — mieux noté que lui, qui passe avant lui. **Aucune** page Facebook, Instagram ou TikTok
rattachable : la page « Univers Optique · 508 likes · Global trade invesment » est un homonyme de métier
différent, donc **ni revendiquée ni liée**.

**Le cadrage qui a remplacé ma phrase fausse, et il est plus fort :** *ce n'est pas qu'il est absent du web
— c'est que sa seule page vivante est celle d'un autre.* Écrit dans la page (section *Le dossier*, six
constatations avec URL + date), **pas** en correction publique du client : ses deux numéros fixes
contradictoires, son « 15 % » et son unique e-mail deviennent **six questions qu'il tranche lui-même**.

### 2 · Le build, et pourquoi un dossier et pas une vitrine

Rituels faits dans l'ordre : `AMK-DESIGN-SKILLS.md` §1–§2 relus + §3.1/§3.2 (règle maison : le crosshair
et la grille de réticule décorative sont **bannis**, donc la « planche d'acuité » du Cristallin ne pouvait
être ni copiée ni approchée), `PRE-FLIGHT.md` §2.6 (unicité), **`AMK-SEO-PLAYBOOK.md` lu en entier** (règles
1, 2, 4 + tableau de mots-clés).

> **Design Read :** « une reprise de fiche publique pour les habitants de Bépanda ET pour les RH/mutuelles
> qui achètent des verres de sécurité — dans la langue administrative du document, penchée vers un dossier
> d'affaires plutôt qu'une vitrine. » · **Dials V7 / M4 / D5** (le preset conversion 6/4/4, poussé d'un cran
> parce que la promesse était « on a tout lu ») · **Mode §12 : greenfield sur archive** (rien à préserver).

**Archétype : la COUVERTURE D'UN DOSSIER** — fiche d'établissement à 8 champs + tampon « à reprendre », puis
vis-à-vis *ce que j'ai lu* ↔ *la reprise*, registre des 10 actes à filets, créneaux WhatsApp, sa vraie note
3,3, six questions. **Différent sur 6 axes** au registre d'unicité (archétype, ouverture, palette, typo,
preuve, angle) : papier chaud `#F2EDE3` / bleu-petrole `#14344A` / **une seule encre rouge brique** ·
**Bricolage Grotesque + Public Sans + JetBrains Mono** · langue administrative.

Fichiers : `demos/univers_optique_content.py` → `.json` (toute la copie, + dictionnaire `SOURCES`),
`demos/build_univers_optique.py` (zéro phrase dans le gabarit), `demos/img/univers-optique-{shop,bench,customer}.jpg`
(générés, **étiquetés** « Rendu de concept — votre photo le remplacera » en FR et EN),
`clients/univers-optique/{inspiration,build-notes}.md`, ligne au registre, slug `univers` dans
`hosting/build_previews.py`. **Deux contrôles qui n'existaient pas ce matin** et qui ont mordu : une
assertion anti-**collision de classes** (mutée exprès → `✗ {'pagefoot': ['div','footer']}`) et une
assertion de **couverture bilingue de la COPIE** (le DOM ne peut pas compter des spans cachées).

**État livré :** `demos/concept-univers-optique-v1.html` **927 Ko** · `audit_html.py` **0 finding** sur la
démo **et** sur `hosting/previews/univers/index.html`, `diff` = **0 ligne**, `:4173/univers/` = **200** ·
167 paires FR|EN · 8 sections / 1 eyebrow · 3 `<img>` lazy+alt+dims · 21 liens WhatsApp vers **son** numéro ·
JSON-LD `Optician` sans `aggregateRating` ni `sameAs` · **repli d'envoi généré** :
`demos/concept-univers-optique-v1-sobre.html` **83 Ko**, audit 0 finding lui aussi. Feuille
`sales/Send-UNIVERS-OPTIQUE-2026-09-22-Soir.md` (version A preuve / version B prix re-posé, **aucune**
promesse de page Facebook) — **l'envoi est dû avant 09:00 mardi 22/09**.

### 3 · Et surtout : DEUX trous trouvés dans le CRM en voulant l'inscrire — corrigés à la source

**(a) `bash leads/build/rebuild.sh` a EFFACÉ l'état de Le Cristallin.** En ajoutant la ligne Univers, le
rebuild a rendu `stage=prospecting`, `Facebook` vide, `Follow-up date` vide : les valeurs « closing / 515
likes / verbatim de la vocale » avaient été écrites **dans `leads/CRM.csv`**, pas dans `leads/build/crm.py`.
Le CSV est une sortie : **tout ce qu'on y tape à la main meurt au premier passage, en silence.** (C'est la
5ᵉ fois que ce piège mord dans ce dépôt — `Daily Ops.csv`, KEYMAP, les deux graphies, le lien Vercel.)
**Corrigé de cause :** `EVENING_2109` + `_apply_evening()` dans `crm.py` — l'état des fils chauds vit
désormais **dans le générateur**, appliqué **après** toutes les fusions ; trois garde-fous machine : un
**slug inconnu fait échouer le build** (muté et vérifié : `rc=1`, CSV intact), une **clé non canonique fait
échouer le build** (elle a mordu immédiatement sur `bamfam_*`, `Last FB post`, `first_touched` → tous
remisés dans `Notes`/`Conversation`), et **deux rebuilds d'affilée produisent un CSV identique** (vérifié).

**(b) Notre tableau de bord était aveugle au stage le plus chaud.** `closing` n'était dans
`STAGE_ORDER` **ni** dans `STAGE_LABEL` de `views.py` : nos deux meilleurs fils (prix posé, aperçu
construit) ne figuraient **nulle part** dans `PIPELINE.md`, parce que la boucle saute toute valeur
inconnue. Le compteur n'était pas faux, il était **muet**. Corrigé : étapes `won / closing / lost /
aperçu envoyé` ajoutées (vocabulaire canonique de King, `closing ≠ offer`), **et une assertion : aucun
stage présent dans le CSV ne peut rester hors de la vue.** `PIPELINE.md` sort maintenant avec
« **④ Prix posé, en négociation — 2** » (Le Cristallin, Univers Optique) · 47 contactés · **4 réponses
humaines · PRR 8,5 %** · 0 client · 0 FCFA.

**(c) Le contrecoup du DNS :** `openpyxl` manquait dans le bac (le rebuild refusait de lire le classeur) →
installée (`openpyxl 3.1.5`, déjà requis par `crm.py`). À savoir pour le prochain bac neuf.

**Ce qui reste ouvert :** l'envoi de l'aperçu Univers (dû avant 09:00) ; la réponse de King sur le périmètre
