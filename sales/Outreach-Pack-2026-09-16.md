...
### 2a · Cabinet Dentaire The Skye — Bonamoussadi ⭐ NAMED GIFT UPGRADE (do this FIRST, ~14:30)
**+237 677 79 69 99** (secours 672 67 65 70) · King-verified WA business profile w/ logo · dossier complet `sales/research/The-Skye-deep-dive-2026-09-16.md`.
...
> **⛔ 17/09 — SKIPPÉ (gate échoué, ne pas envoyer).** Vérifications King ce jour : le numéro publié sur leur propre page Facebook (**674 84 39 02**) **n'est pas sur WhatsApp** ; **dernière publication FB = 24 juin 2022** (page dormante) ; le domaine est mort depuis le 16/09. Trois lignes possibles, **aucune vérifiée comme ligne WhatsApp active** → notre canal est WhatsApp-first, la cible est **injoignable**. S'ajoute le profil **board buyer** (11–50 employés depuis 2009, règle « no chase »). **Décision : parqué en dormant** — réouverture uniquement si (a) une ligne WhatsApp vérifiée apparaît, ou (b) un contact direct du décideur est confirmé. Le temps de vente va aux opticiens (Bali / Maison Optique, concept optique sans nom) et aux réponses en cours.
