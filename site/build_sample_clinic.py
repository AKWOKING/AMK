...
.lang{flex:none}
.logo{min-width:0}
.logo .t{overflow:hidden;text-overflow:ellipsis}
...
.proof-rate .stars{color:#E8A33D;font-size:21px;letter-spacing:2px}
.proof-rate .big{font-size:46px;font-weight:800;color:var(--g800);line-height:1.05;margin:2px 0}
.proof-rate .who{font-size:12.5px;color:var(--muted)}
.proof-rate a{display:inline-block;margin-top:8px;font-size:13px;font-weight:700;color:var(--emerald);text-decoration:none}
.proof-q{display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px}
.proof-q blockquote{background:var(--bone);border:1px solid var(--line);border-radius:14px;padding:16px 17px;font-size:13.5px;color:var(--g700)}
.proof-q b{display:block;margin-top:9px;font-size:12.5px;color:var(--g800)}
.follow{display:flex;flex-wrap:wrap;gap:11px;align-items:center;justify-content:center;margin-top:26px}
.follow .lbl{font-size:13.5px;font-weight:700;color:var(--muted)}
.follow a{display:inline-flex;align-items:center;gap:8px;min-height:44px;padding:10px 18px;border-radius:999px;border:1.5px solid rgba(21,86,66,.28);text-decoration:none;font-size:13.5px;font-weight:700;color:var(--g800);background:var(--card)}
.follow a:hover{border-color:var(--emerald);background:var(--amber-t)}
/* mobile cta */
...
<section class="proof">
  <div class="wrap proof-grid">
    <div class="proof-rate rv">
      ...
      <div class="who" data-en="Google rating · 126 reviews (demo)" data-fr="Note Google · 126 avis (démo)">Google rating · 126 reviews (demo)</div>
      <!-- LAUNCH: replace href with the clinic's real Google Business Profile 'reviews' URL -->
      <a href="#" data-en="Read every review on Google →" data-fr="Lire tous les avis sur Google →">Read every review on Google →</a>
    </div>
    <div class="proof-q">
      <blockquote class="rv" style="transition-delay:.05s" data-en="“I booked on WhatsApp from Bonabéri at 7am and was seen by 8. The price was exactly what the website said.”<b>— Patient, Douala (demo)</b>" data-fr="« J'ai réservé sur WhatsApp depuis Bonabéri à 7h et j'étais reçu à 8h. Le prix était exactement celui du site. »<b>— Patient, Douala (démo)</b>">“I booked on WhatsApp from Bonabéri at 7am and was seen by 8. The price was exactly what the website said.”<b>— Patient, Douala (demo)</b></blockquote>
      <blockquote class="rv" style="transition-delay:.1s" data-en="“My lab results came to my phone the same day, explained in French. No second trip across town.”<b>— Patient (demo)</b>" data-fr="« Mes résultats d'analyse sont arrivés sur mon téléphone le jour même, expliqués en français. Pas besoin de retraverser la ville. »<b>— Patient (démo)</b>">“My lab results came to my phone the same day, explained in French. No second trip across town.”<b>— Patient (demo)</b></blockquote>
      <blockquote class="rv" style="transition-delay:.15s" data-en="“They answered in English for my husband and French for my mother. Nobody does that.”<b>— Family of a patient (demo)</b>" data-fr="« Ils ont répondu en anglais pour mon mari et en français pour ma mère. Personne ne fait ça. »<b>— Famille d'un patient (démo)</b>">“They answered in English for my husband and French for my mother. Nobody does that.”<b>— Family of a patient (demo)</b></blockquote>
    </div>
  </div>
</section>
...
<section style="padding:54px 0 60px">
  <div class="wrap center rv">
    <h2 style="font-size:clamp(22px,2.6vw,28px)" data-en="Not ready to book? Keep us in your pocket" data-fr="Pas encore prêt à réserver ? Gardez-nous sous la main">Not ready to book? Keep us in your pocket</h2>
    <p class="sub" style="margin:8px auto 0" data-en="Opening-hour changes, vaccination days and health tips — no noise, in English and French." data-fr="Changements d'horaires, jours de vaccination et conseils santé — sans bruit, en anglais et en français.">Opening-hour changes, vaccination days and health tips — no noise, in English and French.</p>
    <div class="follow">
      <span class="lbl" data-en="Follow:" data-fr="Suivez :">Follow:</span>
      <!-- LAUNCH: replace each href with the clinic's real social page; delete any they do not have -->
      <a href="#">📘 Facebook</a>
      <a href="#">📸 Instagram</a>
      <a href="#">🎵 TikTok</a>
    </div>
...
(function(){ var p = new URLSearchParams(location.search).get("lang"); var s = null; try{ s = localStorage.getItem("amk-lang"); }catch(e){} if(p === "fr" || p === "en"){ setLang(p); } else if(s === "fr" || s === "en"){ setLang(s); } })();
</script>
</body>
</html>
"""
